...
{
  ros::init(argc, argv, "tb_process_client_node");
  ros::NodeHandle nh;
  ros::NodeHandle private_nh("~");
	ros::Subscriber os2 = nh.subscribe("/tb_process/path_clusters",1,path_clusters_cb);
	...
	pub_paths_to_bbpoly = nh.advertise<tb_msgsrv::Paths>("/tb_process/get_paths_bbpolys",10);
	ros::spin();
	return 0;
}
//
