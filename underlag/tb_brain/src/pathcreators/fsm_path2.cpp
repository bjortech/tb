...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub_orig = nh.advertise<nav_msgs::Path>("/tb_path2",100);
  ros::Publisher pub_path_zn   = nh.advertise<nav_msgs::Path>("/tb_path2/zn",100);
  ros::Publisher pub_path_bb   = nh.advertise<nav_msgs::Path>("/tb_path2/bb",100);
  ros::Publisher pub_path_vstd = nh.advertise<nav_msgs::Path>("/tb_path2/vstd",100);
  ros::Publisher pub_path_not_vstd = nh.advertise<nav_msgs::Path>("/tb_path2/tb_path_not_visited",100);
  pub = nh.advertise<nav_msgs::Path>("/tb_path2/updates",100);
